...
q_desired = [qd1;qd2;qd3];
qd_desired = [vd1;vd2;vd3];
qdd_desired = [ad1;ad2;ad3];

aq = qdd_desired - Kv*(qd_measured - qd_desired ) - Kp*(q_measured - q_desired )
[qdd,M,C,G]=dynamics(0);

u = M*aq + C*qd_measured + G 
function [qdd,M,C,G ] = dynamics(u)
